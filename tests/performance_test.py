...
from nano_lib_py.work import _work
    ...
    def pow_solve_speed_test():
        ...
        for flag in supported_flags:
            elapsed = timeit.Timer(
                ...
                ("from nano_lib_py import _work_{} as _work\n"
                 "from hashlib import blake2b\n"
                 "block_hash = blake2b(\n"
    ...
    def account_gen_speed_test():
        ...
        elapsed = timeit.Timer(
            ("i = 0\n"
             ...
             "    i += 1"),
            ("from nano_lib_py.accounts import generate_seed, generate_account_id, generate_account_key_pair\n"
             "seed = generate_seed()")
        ).timeit(ITERATIONS)
